...
def main():
    ...
    ss_volume_id, selected_az, snapshot_id = create_snapshot.snapshot2volume(client, selected_ec2_vol_id)
    ...
    create_ec2_instance.scan_and_report(client, instance_ip, rand_port, ec2_inst_id, snapshot_id)
